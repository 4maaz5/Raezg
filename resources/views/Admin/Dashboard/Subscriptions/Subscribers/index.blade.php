                                ...
                                <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="px-0 text-muted">Plan_Name</th>
                                            <th scope="col" class="px-0 text-muted">Start_date</th>
                                            <th scope="col" class="px-0 text-muted">End_date</th>
                                            <th scope="col" class="px-0 text-muted">
                                                Status
                                            </th>

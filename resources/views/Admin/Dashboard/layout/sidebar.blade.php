                     ...
                     <ul id="sidebarnav">
                         ...
                         <li class="sidebar-item">
                             ...
                             <ul aria-expanded="false" class="collapse first-level">
                                 ...
                                 <li class="sidebar-item">
                                     <a class="sidebar-link justify-content-between" href="{{ route('admin-blog') }}">
                                         <div class="d-flex align-items-center gap-3">
                         ...
                         <li class="sidebar-item">
                             ...
                             <ul aria-expanded="false" class="collapse first-level">
                                 ...
                                 <li class="sidebar-item">
                                     <a class="sidebar-link justify-content-between" href="{{ route('projects') }}">
                                         <div class="d-flex align-items-center gap-3">
                                             <div class="round-16 d-flex align-items-center justify-content-center">
                                                 <i class="ti ti-circle"></i>
                                             </div>
                                             <span class="hide-menu">Project Posts</span>
                                         </div>
                         ...
                         <li class="sidebar-item">
                             ...
                             <ul aria-expanded="false" class="collapse first-level">
                                 <li class="sidebar-item">
                                     <a class="sidebar-link justify-content-between" href="{{ route('subscription') }}">
                                         <div class="d-flex align-items-center gap-3">
                                             <div class="round-16 d-flex align-items-center justify-content-center">
                                                 <i class="ti ti-circle"></i>
                                             </div>
                         ...
                         <li class="sidebar-item">
                             ...
                             <ul aria-expanded="false" class="collapse first-level">
                                 ...
                                 <li class="sidebar-item">
                                     <a class="sidebar-link justify-content-between" href="{{ route('news') }}">
                                         <div class="d-flex align-items-center gap-3">
                                             <div class="round-16 d-flex align-items-center justify-content-center">
                                                 <i class="ti ti-circle"></i>
                                             </div>
                                             <span class="hide-menu">News Posts</span>
                                         </div>
                                 ...
                                 <li class="sidebar-item">
                                     <a class="sidebar-link justify-content-between" href="#">
                                         <div class="d-flex align-items-center gap-3">
                                             ...
                                             <span class="hide-menu">Posts Details</span>
                                         </div>
